...
export default function ManagerChat() {
  ...
  return (
    <div
      ...
      style={{ minHeight: "100vh", background: palette.pageBg, paddingTop: "90px", paddingBottom: "40px" }}
    >
      <ManagerNav />
      <div
        style={{
      ...
      >
        ...
        >
          <div style={{ padding: 16, borderBottom: `1px solid ${palette.divider}`, background: palette.cardBg }}>
            <h3 style={{ margin: 0, fontSize: 16, color: palette.textPrimary }}>Customer Threads</h3>
          </div>
          <div style={{ flex: 1, overflowY: "auto", background: palette.cardBg }}>
          {loadingCustomers ? (
            ...
            customers.map((c) => {
              ...
              return (
                ...
                >
                  <div style={{ fontWeight: 600, fontSize: 14, color: palette.textPrimary }}>
          ...
          <div style={{ padding: 12, borderTop: `1px solid ${palette.divider}`, background: palette.cardBg }}>
          <button
        ...
        <main style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px", background: themeMode === "dark" ? "#0f131a" : "#f7f9fc" }}>
          {!activeCustomer ? (
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                marginLeft: 12,
                borderRadius: 30,
                background: activeCustomer ? palette.sendEnabledGrad : palette.sendDisabledBg,
                color: "#fff",
                fontWeight: 600,
                border: "none",
                cursor: activeCustomer ? "pointer" : "not-allowed",
                boxShadow: activeCustomer ? (themeMode === "dark" ? "0 4px 10px rgba(0,0,0,0.35)" : "0 4px 10px rgba(0,0,0,0.15)") : "none",
              }}
            >
              Send
            </button>
